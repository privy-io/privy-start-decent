  ...
  return (
    <div className={`${styles.container} background`}>
      <Head>
        ...
        <meta
          name="description"
          content='A template for implementing the Decent Protocol wtih Privy in Next JS'
        />
      ...
      <main className={styles.main}>
        ...
        <div className={`${styles.description} flex items-center gap-2`}>
          ...
          <a className='pt-2' href="https://decentxyz.gitbook.io/decent-sdk-documentation/"><Image src='/images/icon.png' height={20} width={25} alt='decent icon'/></a>
					<p>+</p>
          <a href='https://privy.io'><Image src='/images/privy.png' height={20} width={25} alt='Privy logo' /></a>
