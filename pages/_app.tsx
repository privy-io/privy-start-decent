...
const wagmiClient = createClient({
  autoConnect: true,
  provider: configureChainsConfig.provider,
  webSocketProvider: configureChainsConfig.webSocketProvider,
});
...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return (
    <WagmiConfig client={wagmiClient}>
      <PrivyProvider appId={process.env.NEXT_PUBLIC_PRIVY_APP_ID || ''} onSuccess={() => router.push("/deploy-contracts")}>
